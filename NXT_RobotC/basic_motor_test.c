#pragma config(Motor,  motorA,          Track,         tmotorNXT, PIDControl, encoder)
...
task main()
{
   motor[Track] = 100;		//motors can used default names or custom names set in the "Motor and Sensor Setup" Menu
