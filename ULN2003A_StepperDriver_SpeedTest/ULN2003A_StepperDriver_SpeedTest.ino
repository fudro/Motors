 ...
 * 
 * FUNCTIONALITY:
 * Rotates the stepper motor one-half turn Clockwise.
 * Then rotates one-half turn Counter-Clockwise to return to the starting position.
 * Calculates the time (in seconds) to rotate one-half turn.
 * Prints the results to the Serial Monitor.
 * 
 * NOTES:
 * Based on tests, the max speed value for this stepper motor is 1000. 
 * All values above that do not provide increased rotation speed of the stepper shaft.
 * 
 */
